...
<?php
	...
	if($_POST['edited_lesson']) { // Record has been edited
		...
		redirect_to("viewLanguageSeries.php?series={$edited_lesson->series_id}&id={$edited_lesson->language_series_id}");
		...
		redirect_to("viewLanguageSeries.php?series={$deleted_record->series_id}&id={$deleted_record->language_series_id}");
		...
		if (!$current_record->title) {
			redirect_to("viewLanguageSeries.php?series={$current_record->series_id}&id={$current_record->language_series_id}.php");
		}	
	}
?>
...
<?php include_layout_template('header.php'); ?>
	<div>
		...
		<form action="editLesson.php?id=<?php echo $current_record_id; ?>" method="POST">
