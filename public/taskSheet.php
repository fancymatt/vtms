...
*/
	...
	if($_POST['task_activated']) {
		...
		redirect_to("taskSheet.php?member={$team_member_id}");
	}
	...
	<div id="active_task_list">
		<table id=>
			...
			<tr>
				...
				<td><form action='taskSheet.php?member=<?php echo $team_member_id; ?>' method='post'>
					<input type='hidden' name='task_id' value='<?php echo $active_task->id; ?>'>
					<input type='submit' name='task_deactivated' value='Deactivate'>
					</form>
					<form action='taskSheet.php?member=<?php echo $team_member_id; ?>' method='post'>
					<input type='hidden' name='task_id' value='<?php echo $active_task->id; ?>'>
